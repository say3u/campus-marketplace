    ...
    <div className="min-h-[90vh] flex items-center justify-center px-4" style={{ backgroundColor: '#F8FAFC' }}>
      <div className="w-full max-w-sm">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold mt-6 mb-1" style={{ color: '#0F172A' }}>Create an account</h1>
          <p className="text-sm" style={{ color: '#94A3B8' }}>Requires a .edu email address</p>
        </div>

        <div className="rounded-xl border p-6 bg-white" style={{ borderColor: '#E2E8F0', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: '#475569' }}>School email</label>
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: '#475569' }}>Username</label>
        ...
        <p className="text-center text-sm mt-5" style={{ color: '#94A3B8' }}>
          ...
          <Link to="/login" className="font-semibold hover:underline" style={{ color: '#3B82F6' }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
