  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        {status === 'success' && (
          <>
            <CheckCircle size={48} className="mx-auto mb-4" style={{ color: '#14B8A6' }} />
            ...
            <Link to="/browse" className="text-sm font-semibold text-white px-6 py-2.5 rounded-lg"
              style={{ backgroundColor: '#14B8A6' }}>Go to marketplace</Link>
          </>
        )}
        {status === 'error' && (
          <>
            ...
            <Link to="/" className="text-sm font-semibold" style={{ color: '#14B8A6' }}>Go home</Link>
          </>
        )}
      </div>
    </div>
