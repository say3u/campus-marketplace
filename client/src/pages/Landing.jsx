...
const CATEGORIES = [
  { name: 'Electronics',  emoji: '💻', bg: '#EFF6FF', color: '#2563EB' },
  { name: 'Textbooks',    emoji: '📚', bg: '#FFFBEB', color: '#D97706' },
  { name: 'Furniture',    emoji: '🛋️', bg: '#F0FDF4', color: '#16A34A' },
  { name: 'Clothing',     emoji: '👕', bg: '#FDF4FF', color: '#A21CAF' },
  { name: 'Services',     emoji: '🔧', bg: '#F5F3FF', color: '#7C3AED' },
  { name: 'Other',        emoji: '📦', bg: '#FFF7ED', color: '#EA580C' },
];
    ...
    <div style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 pt-24 pb-16 text-center">
        <h1 className="text-6xl font-extrabold leading-tight mb-5 tracking-tight" style={{ color: 'var(--text)' }}>
          Your campus.<br />
          <span style={{ color: '#3B82F6' }}>Your marketplace.</span>
        </h1>
        <p className="text-xl leading-relaxed max-w-xl mx-auto mb-10" style={{ color: 'var(--text3)' }}>
          Buy and sell textbooks, furniture, electronics and more — only with verified students at your school.
        </p>
      ...
      {/* ── CTA banner ───────────────────────────────────── */}
      <div className="mx-6 mb-20 rounded-3xl overflow-hidden" style={{ backgroundColor: '#3B82F6' }}>
